...
content = '''package com.onlinejobportal.service.impl;
...
# Write the file
filepath = os.path.join(os.getcwd(), 'src', 'main', 'java', 'com', 'onlinejobportal', 'service', 'impl', 'JobServiceImpl.java')
os.makedirs(os.path.dirname(filepath), exist_ok=True)
with open(filepath, 'w', encoding='utf-8') as f:
    f.write(content)
print(f"Written successfully to {filepath}")
